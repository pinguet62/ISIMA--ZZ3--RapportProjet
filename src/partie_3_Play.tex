...
\textit{WebSocket} est un protocole standard du Web et normalisé.
Il permet une communication bidirectionnel entre client et serveur dans les navigateurs et serveurs web en se basant sur une socket TCP.

Pour réaliser notre solution il est nécessaire d'utiliser ce mécanisme pour permettre d'avoir une page dynamique sans avoir à la rafraichir.
Lors de la réception d'un SMS celui-ci pourra s'afficher automatiquement à l'écran.
