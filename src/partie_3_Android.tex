...
\\\\
%\includegraphics[scale=0.09]{img/fonctionnement-des-services-android.png}
\\\\
...
%serveur gtalk->Application: authentification validéA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\\\\
%\includegraphics[scale=0.09]{img/obtention-token-avec-android.png}
\\\\
...
\\\\
%\includegraphics[scale=0.09]{img/pattern-strategie.png}
\\
