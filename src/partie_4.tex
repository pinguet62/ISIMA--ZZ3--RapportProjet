...
Comme le montre le schéma \ref{broadcast-xmpp}, lors de l'envoi d'un message XMPP originellement destiné uniquement à une application ou au web service, c'est tous l'environnement qui reçoit et affiche le nouveaux messages.
...
pour réaliser certaines fonctionnalités. Rendre notre travail publique sur un market ne serait donc sûrement pas possible ou bien
